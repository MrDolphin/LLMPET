...
| 🎨 | **三款皮肤** | 章鱼 + 像素怪兽（美术与动画原创），另有月薪喵 meme 皮肤（素材来自抖音 @月薪喵，见 `assets/cat/CREDITS.md`） |
...
以 **MIT** 开源。章鱼/像素怪兽形象、渲染动画与后端实现均为原创，仅对接 Claude Code 的公开 hook 接口。月薪喵皮肤素材版权归原作者（抖音 @月薪喵）所有，仅作皮肤使用，见 [`assets/cat/CREDITS.md`](../assets/cat/CREDITS.md)。
